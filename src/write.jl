...
write(io::IO, obj::DateTime; datetimeformat=nothing, dateformat=Dates.ISODateTimeFormat, kwargs...) = (Base.write(io, "\"$(Dates.format(obj, something(datetimeformat, dateformat)))\""); return)

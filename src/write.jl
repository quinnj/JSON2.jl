...
write(io::IO, obj::Date; dateformat=ISODateFormat, kwargs...) = (Base.write(io, "\"$(Dates.format(obj, dateformat))\""); return)
write(io::IO, obj::DateTime; datetimeformat=ISODateTimeFormat, kwargs...) = (Base.write(io, "\"$(Dates.format(obj, datetimeformat))\""); return)
